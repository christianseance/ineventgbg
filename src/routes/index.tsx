          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end min-h-[70vh]">
            ...
            <div className="lg:col-span-8 fade-up">
              ...
              <p className="mt-8 text-lg lg:text-xl text-muted-foreground max-w-2xl leading-relaxed">
                Cirkustält, event-tält, beduintält, glamping, interiör, belysning, teknik och scenbyggen. Nämn det vi <em className="italic text-foreground">inte</em> har själva i tältväg eller inom event i vårt fantastiska nätverk..? Vi utgår från Göteborg, men dyker upp där vi behövs!
              </p>
